...
$(document).ready(function () {
    email = "ofvrfgbe@tznvy.pbz".replace(/[a-zA-Z]/g, function (c) {
    ...
    $('a.mailto').click(function () {
        window.location.href = "znvygb:ofvrfgbez@tznvy.pbz".replace(/[a-zA-Z]/g, function (c) {
            return String.fromCharCode((c <= "Z" ? 90 : 122) >= (c = c.charCodeAt(0) + 13) ? c : c - 26);
        });
    });
});
